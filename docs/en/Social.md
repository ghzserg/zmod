...
Join our community! Here you'll find official support channels, discussion groups, and resources for interacting with the project.
...
1. **For quick questions** – use the Help Bot
2. **For news** – subscribe to the official channel
3. **For discussions** – join the Telegram group
4. **For development** – explore the GitHub repository

## 📱 Stay Connected

Choose the most convenient platform for receiving updates and communicating with the community. All official resources are marked with appropriate icons.
