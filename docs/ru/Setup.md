...
7. Дождаться установки мода
   ...
   Если пропустили окно с зеленой галочкой и пр нткрмавтоматически перезагрузился, то загрузится стандартный экран принтера, в этом случае можно пемеходить сразу к 12 пункту меню.
