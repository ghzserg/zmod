...
!!! tip
    [Калибровка принтера для новичков](/ru/Setup/#калибровка-принтера-для-новичков)
...
[Как работает Z-Offset на вашем принтере](/ru/Setup/#как-работает-z-offset-на-вашем-принтере)
