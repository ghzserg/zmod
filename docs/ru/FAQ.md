...
Прочитайте статью "[Как работает Z-Offset на нашем принтере](/ru/Setup/#как-работает-z-offset-на-вашем-принтере)"
...
- Модули 4 в 1 и трубки к ним имеют разную длину, поэтому нужно отрегулировать параметр ```nozzle_cleaning_length``` в ```mod_data/filament.json``` установив его 70 или больше. [Подробнее](/ru/AD5X/#самые-важные-настройки-что-менять-чаще-всего-ad5x)
