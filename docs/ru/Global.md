...
2.  **Подготовка:**
    ...
    *   Сопло прогревается до рабочей температуры, очищается о стол и остывает до температуры замера: [TEMP_TEST_MAX](/ru/Global/#temp_test_max) (по умолчанию 151), если целевая температура сопла выше 230°C, иначе [TEMP_TEST_MIN](/ru/Global/#temp_test_min) (по умолчанию 121).
