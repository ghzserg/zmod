...
*   `Extruder: 1 (PETG/Orange)` – Это значит, что сейчас в принтер заправлен оранжевый пластик PLA из катушки номер 1.
...
1. Введите команду `_REZGEM_PRUTOK` — голова поедет к ножу.
