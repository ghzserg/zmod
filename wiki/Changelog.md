...
- AD5X - создана [флешка устанавливающая экран версии 1.0.7, а все остальные модули версии 1.1.1](https://github.com/ghzserg/zmod/releases/tag/R)
- AD5x - создана [флешка возврата принтера к заводским настройкам](https://github.com/ghzserg/zmod/releases/tag/R)
- AD5X - создана [флешка активации мода, после обновления родной прошивки](https://github.com/ghzserg/zmod/releases/tag/R)
