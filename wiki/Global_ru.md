...
- `ZCONTROL_AUTO` - при сработке останавливать Klipper(если высота z < 10), или вызывать PAUSE при z >= 10
...
Тестировать карту стола перед печатью 0-нет, 1-да, 2-тестировать, в случае несовпадения, запускать KAMP (1).
