...
Любоую функцию можно переопределить `mod_data/user.cfg` или `printer.cfg`
...
- [Устанавливаем родную Factory прошивку](https://github.com/ghzserg/zmod/wiki/R#how-to-install-native-firmware), которая установит родной MCU.
...
- В экструдере  пруток 1, а вытягивается пруток 2
- В экструдер вставляется пруток, но в нем уже ест ьстарый пруток
