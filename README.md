...
- [AD5X](https://wiki.zmod.link/AD5X/): only (1.0.2, 1.0.7, 1.0.8, 1.0.9, 1.1.1, 1.1.6, **1.1.7**, 1.1.9, 1.2.0, 1.2.1, 1.2.2, 1.2.3, 3.0.3, 3.0.9, 3.1.0, 3.1.5, 3.1.6) _any IFS version_
- [Creator 5/Creator 5 Pro](https://wiki.zmod.link/C5PRO/) **only** (1.9.5, 1.9.6, 1.9.7, 1.9.8, 1.9.9).
