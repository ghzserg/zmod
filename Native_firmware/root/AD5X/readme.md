...
2. **Download and save** the file [AD5X-root.tgz](https://github.com/ghzserg/zmod/releases/download/R/AD5X-root.tgz) to USB
...
- Сохраните на usb flash файл [AD5X-root.tgz](https://github.com/ghzserg/zmod/releases/download/R/AD5X-root.tgz)
- Выключите принтер
