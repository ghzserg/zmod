...
2. **Download and save** the file [Adventurer5MPro-root.tgz](https://github.com/ghzserg/ff/releases/download/R/Adventurer5MPro-root.tgz) to USB
...
- Сохраните на usb flash файл [Adventurer5MPro-root.tgz](https://github.com/ghzserg/ff/releases/download/R/Adventurer5MPro-root.tgz)
- Выключите принтер
